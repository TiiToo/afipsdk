	...
	function __construct($options)
	{
		...
		if (!isset($options['CUIT'])) {
			...
			$this->CUIT = $options['CUIT'];
                ...
                if (!isset($options['CUITOrganismo'])) {
			throw new Exception("CUIT Organismo field is required in options array");
		} else {
			$this->CUITOrganismo = $options['CUITOrganismo'];
		}
