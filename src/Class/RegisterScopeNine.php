...
class RegisterScopeNine extends AfipWebService {

	var $soap_version 	= SOAP_1_1;
	var $WSDL 			= 'ws_sr_padron_a9.wsdl';
	var $URL 			= 'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA9';
	var $WSDL_TEST 		= 'ws_sr_padron_a9.wsdl';
	var $URL_TEST 		= 'https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA9';
	...
	**/
	public function getPersona($identifier)
	{
		$ta = $this->afip->GetServiceTA('ws_sr_padron_a9');
